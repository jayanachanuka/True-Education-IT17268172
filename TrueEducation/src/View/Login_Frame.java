...
public class Login_Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/images/graduate.png"))); // NOI18N

        jLabel13.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("University Management System");
        ...
        exit.setForeground(new java.awt.Color(45, 118, 232));
        exit.setText("X");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        boolean success = LoginController.Login_Controller(loginModel);

        if (success) {
            this.dispose();
            JOptionPane.showConfirmDialog(null, "You are successfully logged in", "Success", JOptionPane.DEFAULT_OPTION);
        } else {
            JOptionPane.showConfirmDialog(null, "Invalid username or password", "Error", JOptionPane.DEFAULT_OPTION);
        }
